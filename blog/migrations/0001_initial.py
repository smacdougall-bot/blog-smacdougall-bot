# Generated by Django 3.0.2 on 2020-02-21 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('published', 'Published')], default='draft', help_text='Set to "published" to make post publicly visible', max_length=10)),
                ('published', models.DateTimeField(blank=True, help_text='The date and time this article was published', null=True)),
                ('slug', models.SlugField(help_text='Human readable URL path', unique_for_date='published')),
